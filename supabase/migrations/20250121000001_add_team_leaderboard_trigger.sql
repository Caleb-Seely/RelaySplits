-- Phase 2: Add trigger to automatically update leaderboard when team data changes
-- Note: Leaderboard entries are now created manually after team setup is complete
